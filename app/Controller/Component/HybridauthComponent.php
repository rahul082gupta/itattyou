...
class HybridauthComponent extends Component {
    ...
    protected function init(){
        ...
        $config = array(
            ...
            "providers" => array("Google" => array ( 
                "enabled" => true,
                "keys"    => array ( "id" => "1049473149884-nefu5pefj8a487mdevr5otckamsdskct.apps.googleusercontent.com", "secret" => "QQjRhrluTzdBJnskmgV1CHIr" ), 
            )),
       ...
       /* $config = array(
      "base_url" => "http://localhost/itattyou/users/social_endpoint",
      "providers" => array (
        "Google" => array (
          "enabled" => true,
          "keys"    => array ( "id" => "1049473149884-nefu5pefj8a487mdevr5otckamsdskct.apps.googleusercontent.com", "secret" => "QQjRhrluTzdBJnskmgV1CHIr" ),
